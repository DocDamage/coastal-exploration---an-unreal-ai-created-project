"""Retarget the installed rope hanging loop; preserve prior action bindings."""
import json
...
sources = [('grapple_hang', 'Hold_Rope_Idle_Anim')]
...
(ROOT / 'local-evidence/m3-grapple-hang-retarget.json').write_text(json.dumps(report, indent=2))
